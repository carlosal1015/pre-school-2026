...
- **Ejemplos del libro Numerical Python**: [Cuadernos](https://github.com/carlosal1015/pre-school-2026/tree/main/numericalpython).
- **Lectura sobre EDOs**: https://numerics.ovgu.de/teaching/numnn/skript.pdf
- **Apuntes**: [PDFs](https://github.com/carlosal1015/pre-school-2026/tree/main/imca)
- **Curso de Optimización con ejemplos en Python/MATLAB**: [Lista de reproducción](https://youtube.com/playlist?list=PLMuMITxF1cdjPrCwXFmcfhhr43OPtergp&si=bVTgEvFwfZJig-Xb).
...
| :------------------------------------------------------------------------------------- | :---------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------- |
| *Antes del 6/01*                                                                       | **Sesión 0:** Instalación y Ambiente            | [Instalar `uv`](https://www.youtube.com/watch?v=jF-1tfnqxtA) y familiarizarse con JupyterLab. Crear un notebook que importe NumPy, SciPy y PyTorch para verificar sus versiones. [Ejercicios](https://cpp-review-dune.github.io/python/ex1.pdf).                                                                                                                                                                       | @Aznaran2022 @Aznaran2022a @Aznaran2025      |
| [6/01/2026](https://youtu.be/WEb-s-I8pnc?list=PLWb96MFebtXjpVhTF9N7-CAo1fOtPoB6q&t=28) | **Fundamentos:** de Python a NumPy              | Cargar un dataset (CSV), calcular estadísticas (media, std), y visualizarlo con Matplotlib. Implementar multiplicación de matrices y resolver un sistema lineal con NumPy.                                                                                                                                                                                                                                             | @Gaddis2023 @Wei2022 @Sundnes2020 @Nagar2018 |
| [9/01/2026](https://youtu.be/aQiTLF0bU6Y)                                              | **Optimización I:** Descenso de Gradiente (GD)  | Implementar GD desde cero para minimizar una función (ej. Rosenbrock) y comparar variantes (batch, mini-batch). [Entorno virtual](https://realpython.com/python-virtual-environments-a-primer).                                                                                                                                                                                                                        | @Beck2023 @Grippo2023 @Pec32026              |
...
| [13/01/2026](https://youtu.be/1vI0vAiVU7g)                                             | **Optimización II:** Acelerando la Convergencia | Añadir Momento y una tasa de aprendizaje adaptativa (ej. AdaGrad/RMSProp) a la implementación de GD. [Lecturas de optimización](https://wiki.mcs.anl.gov/leyffer/index.php/Slides_from_Lectures_and_Tutorials). [JuMP.jl](https://jump.dev/JuMP.jl/stable). [PuLP](https://coin-or.github.io/pulp). [Función cuadrática Chapter 7 Section 2](https://homepages.uc.edu/~herronda/linear_algebra/2017-FS-2076-info.html) |                                              |
| [16/01/2026](https://youtu.be/L_k5SRHKQvk)                                             | **Optimización III:** SciPy y ODEs              | Resolver un problema de optimización no lineal con `scipy.optimize.minimize`. Adicionalmente, resolver una Ecuación Diferencial Ordinaria (ODE) simple con `scipy.integrate.solve_ivp`. [Tesis gradiente conjugado](https://minerva.usc.gal/entities/publication/78b44194-6491-4250-a395-7c36e52221e3). [Gradiente conjugado](https://carlosal1015.github.io/winter-school-2025/cg-part2-solution).                    |                                              |
| [20/01/2026](https://youtu.be/LbSJ6NZZud0)                                             | **Optimización IV:** Métodos de 2º Orden        | Implementar el Método de Newton y comparar su convergencia con los métodos de 1er orden. [Proyectos](https://skim.math.msstate.edu/LectureNotes). [Estadística Básica para Ciencias de la Salud](https://matematicas.unex.es/~jmf/Archivos/Manual%20de%20Bioestad%C3%ADstica.pdf). [Estadística](https://www.uv.mx/rmipe/files/2015/09/estadistica.pdf). [¿Qué es el Deep Learning?]()                                 |                                              |
| [23/01/2026](https://youtu.be/OqSgeZc10hU)                                             | **Optimización V:** con Restricciones (KKT)     | Resolver un problema de asignación de recursos (ej. cartera de inversión) usando las condiciones KKT.                                                                                                                                                                                                                                                                                                                  |                                              |
